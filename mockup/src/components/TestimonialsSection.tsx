...
const testimonials = [
  {
    rating: 5,
    quote: '촬영 비용이 월 200만원에서 거의 0원이 됐어요. 퀄리티는 오히려 더 일관성 있고요.',
    name: '김○○ 대표',
    role: '여성의류 전문 쇼핑몰',
  },
  {
    rating: 5,
    quote: '신상품 등록 속도가 3배 빨라졌어요. 이제 촬영 일정에 맞출 필요가 없으니까요.',
    name: '이○○ MD',
    role: '온라인 편집샵',
  },
  {
    rating: 5,
    quote: '모델 섭외, 스튜디오 예약... 이 스트레스가 사라진 것만으로도 가치 있습니다.',
    name: '박○○ 실장',
    role: '남성복 브랜드',
  },
];
                ...
                <div className="p-8 hover:-translate-y-1 transition-transform duration-300">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-[14px] text-[#9E9E9E]">{testimonial.role}</div>
                    </div>
                  </div>
                </div>
