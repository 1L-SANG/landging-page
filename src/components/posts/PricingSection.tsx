                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-[1100px] mx-auto">
                    {plans.map((plan, index) => (
                        <div
                            ...
                            className={`relative transition-all duration-600 ${visibleItems.includes(index)
                            ...
                            {plan.isRecommended ? (
                                <GradientBorderContainer innerClassName="bg-white">
                                    <div className="p-10 relative">
                                        <div className="text-[16px] font-semibold text-[#1A1A1A] mb-3">
                                            {plan.name}
                                        </div>
                                        <div className="mb-6">
                                            <span className="text-[40px] font-extrabold text-[#1A1A1A]">
                                                {plan.price}
                                            </span>
                                        ...
                                        <ul className="space-y-3.5 mb-8">
                                            {plan.features.map((feature, i) => (
                                                <li key={i} className="flex items-start gap-3">
                                                    <Check
                                                        size={18}
                                                        className="text-[#1A1A1A] mt-0.5 flex-shrink-0"
                                                        strokeWidth={2.5}
                                                    />
                                ...
                                <div className="bg-white border-[1.5px] border-[#E5E5E5] rounded-[20px] p-10 shadow-[0_4px_24px_rgba(0,0,0,0.06)] hover:border-[#1A1A1A] transition-all">
                                    <div className="text-[16px] font-semibold text-[#6B6B6B] mb-3">
                                        {plan.name}
                                    </div>
                                    <div className="mb-6">
                                        <span className="text-[40px] font-extrabold text-[#1A1A1A]">
